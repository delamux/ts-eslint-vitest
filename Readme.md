...
Is to provide a solid foundation for TypeScript projects, combining best practices and essential tools to ensure code quality and maintainability. This template is ideal for developers looking to kickstart their projects with a well-configured setup that includes:
...
git clone git@github.com:delamux/ts-eslint-vitest.git
cd ts-eslint-vitest
...
This template is maintained by [Luis del Amo](https://luisdelamo.dev) and being inspired from
[Software crafters](https://github.com/softwarecrafters-io/ts-eslint-prettier-jest). Feel free to use it as a starting point for your projects. Contributions and suggestions are welcome!
